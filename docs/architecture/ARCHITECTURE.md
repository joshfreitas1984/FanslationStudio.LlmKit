...
> Audit snapshot as of 2026-08-23, updated to reflect the completed translation scheduling work.
> This is reference material for future agent conversations and developer onboarding — it
> describes **what the code does today**, not aspirational design.
...
## Translation pipeline (`TranslationService.TranslateViaLlmAsync`)
...
- **`TranslateViaLlmAsyncPooled`** (recommended) —
